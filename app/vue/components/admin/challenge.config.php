    ...
    <div class="list-container">
        ...
        <?php foreach($projets as  $projet) { ?>
                ...
                <div class="list-content">
                    <div class="user-info">
                    <span><?= $projet->getLibelle() ?></span>
                    <span><?= $projet->getDescription() ?></span>
                    </div>
                    <div class="btn-setting">
                        <a href="/admin/deleteProjet?id=<?= $projet->getIdProjet() ?>&idChallenge=<?= $challenge->getIdChallenge() ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="black" d="M6 19a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V7H6v12M8 9h8v10H8V9m7.5-5l-1-1h-5l-1 1H5v2h14V4h-3.5Z"/></svg></a>
        ...
        <a class="bouton" href="/admin?addP">+ ajouter</a>
    </div>
